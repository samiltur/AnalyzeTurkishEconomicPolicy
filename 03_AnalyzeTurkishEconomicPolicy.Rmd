...
linediag2 <- ggplot(data = dataa, aes(x = energyusee, y= gdpgr, color= year)) +geom_point() +my_theme() +labss2 + 
...
linediag3 <- ggplot(dtgdpc, mapping = aes(x = year)) + geom_line(size = 1, mapping = aes(y = EG.GDP.PUSE.KO.PP.KD, color = "GDP per unit of energy use")) + my_theme()
```
