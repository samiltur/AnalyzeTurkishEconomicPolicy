...
Based on the situations I have mentioned, this project examines the relationship between energy production, consumption, and consumption between 1996 and 2020 with gross domestic product and current account balance. We expect a positive relationship between energy consumption and gross domestic product, and between the generation of renewable resources and gross domestic product. We expect a negative relationship between current account balance and energy consumption, as we are externally dependent on energy resources.
