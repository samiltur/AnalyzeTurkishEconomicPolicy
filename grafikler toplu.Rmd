...
search_terms <- c("yenilenebilir", "rüzgar", "rüzgâr", "güneş", "nükleer",
                  "hidroelektrik", "jeotermal", "ngs", "hes", "petrol", "gaz", "kömür")
...
```{r libraries}
my_packages <- c("WDI", "data.table", "ggplot2", "plotly", "CBRT")
...
ggplot(freqsDT, mapping = aes(x = Years)) + 
  geom_line(size = 1, mapping = aes(y = petrol))+
  # geom_line(size = 1, mapping = aes(y = "kömür", color = "Coal")) +
  # geom_line(size = 1, mapping = aes(y = "gaz", color = "Natural Gas"))+
  # geom_point() + 
...
head(DTnuc3)
g7 <- ggplot(DTnuc3, mapping = aes(x = year)) + geom_line(size = 1, mapping = aes(y = EG.USE.COMM.CL.ZS.x, color = "Turkey"))+
  geom_line(size = 1, mapping = aes(y = EG.USE.COMM.CL.ZS.y, color = "Middle Income")) + my_theme() +
  guides(col = guide_legend(""))+ clabsnuc3
ggplotly(g7)

g8 <- ggplot(DTnuc3, mapping = aes(x = year)) + geom_bar(aes(y = EG.USE.COMM.CL.ZS.x, color ="Turkey"), stat ="identity",position =position_dodge())+
  geom_line(size = 1, mapping = aes(y = EG.USE.COMM.CL.ZS.y, color = "Middle Income")) + my_theme() +
  guides(col = guide_legend(""))+ clabsnuc3
ggplotly(g8)
```
...
ggplot(dtproduction, mapping = aes(x = year)) + geom_line(size = 1, mapping = aes(y = EG.ELC.PETR.ZS, color = "Oil"))+
...
head(DTfossil)
ggplot(DTfossil, mapping = aes(x = year)) + geom_line(size = 1, mapping = aes(y = EG.IMP.CONS.ZS.x, color = "Turkey"))+
  geom_line(size = 1, mapping = aes(y = EG.IMP.CONS.ZS.y, color = "Middle Income")) + my_theme() +
  guides(col = guide_legend(""))+ clabs4

ggplot(DTfossil, mapping = aes(x = year)) + geom_bar(aes(y = EG.IMP.CONS.ZS.x, color ="Turkey"), stat ="identity",position =position_dodge())+
  geom_line(size = 1, mapping = aes(y = EG.IMP.CONS.ZS.y, color = "OECD")) + my_theme() +
  guides(col = guide_legend(""))+ clabs4
```
...
head(DTfossil2)
ggplot(DTfossil2, mapping = aes(x = year)) + geom_line(size = 1, mapping = aes(y = EG.IMP.CONS.ZS.x, color = "Turkey"))+
...
ggplot(dtwaste, aes(year, EG.USE.CRNW.ZS)) + geom_line() + my_theme() + clabs
```
...
ggplot(DT8, mapping = aes(x = year)) + geom_line(size = 1, mapping = aes(y = renew, color = "renewable energy consumption"))+
  geom_line(size = 1, mapping = aes(y = gdp, color = "GDP Growth")) + my_theme() + guides(col = guide_legend(""))+ clabs8


ggplot(DT8, mapping = aes(x = year)) + geom_bar(aes(y = renew, color ="Renewable Energy Cons.(%)"), stat ="identity",position =position_dodge())+
...
ggplot(endex, aes(year, index)) + geom_line() + my_theme() + clabs
```
...
ggplot(energy, aes(year, energy)) + geom_line() + my_theme() + clabse
...
clabs <-   labs(title = "GDP Growth and Energy Index",
                ...
                caption = "Source: CBRT")
ggplot(DTenergy, mapping = aes(x = year)) + geom_line(size = 1, mapping = aes(y = energy, color = "Energy Index"))+
...
clabsimex <-   labs(title = "Energy Import and Export",
                ...
                x = "Years", y = "",
                caption = "Source: CBRT")
ggplot(DTimex, mapping = aes(x = year)) + geom_line(size = 1, mapping = aes(y = import, color = "Energy Import"))+
...
ggplot(DTimex1, mapping = aes(x = year)) + geom_bar(aes(y = import, color = " Import"), stat ="identity",position =position_dodge())+
